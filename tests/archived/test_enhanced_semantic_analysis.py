...
class EnhancedSemanticAnalysisTester:
    ...
    def test_api_integration(self):
        ...
        try:
            # Get a recent report
            response = requests.get("https://geo-competitor-fix.preview.emergentagent.com/api/leads", timeout=10)
            ...
            # Get the report
            response = requests.get(f"https://geo-competitor-fix.preview.emergentagent.com/api/reports/{report_id}", timeout=10)
            if response.status_code != 200:
